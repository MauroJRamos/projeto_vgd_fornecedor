...
from ConfigParser import GetLerPathArquivo
from EncontrarArquivo5 import getSourcePathArquivoAndPastaCidade
...
if __name__ == '__main__':
    try:
        ...
        lerArquivo = GetLerPathArquivo()
        if lerArquivo == "S":
            getSourcePathArquivoAndPastaCidade()
                ...
                for row_data in planilha:
                    if len(row_data) >= 11 and any(row_data):
                        ...
                        if fornecedor is not None:
                            ...
                            insertFornecedor(cnx, fornecedor, email, data_solicitacao, retorno_01, tentativa_01, retorno_02, contato01, contato02, contato03, categoria, pasta, ano)
                            print(
                                f"{fornecedor}, {email}, {data_solicitacao}, {retorno_01}, {tentativa_01}, {retorno_02}, {contato01}, {contato02}, {contato03}, {categoria}, {pasta}, {ano}")
                        else:
                            print("LINHA VAZIA")
